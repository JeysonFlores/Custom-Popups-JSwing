...
public class PopupErrorD extends javax.swing.JDialog {

    public PopupErrorD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public PopupErrorD(java.awt.Frame parent, boolean modal, String msg) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setOpacity(0.85f);
    ...
    private void initComponents() {
        ...
        PanelBotonAceptar.setBackground(new java.awt.Color(254, 110, 110));
        ...
        Icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Error.png"))); // NOI18N
        ...
        Titulo.setForeground(new java.awt.Color(254, 110, 110));
        Titulo.setText("Error");
        jPanel1.add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 70, 60));
    ...
    private void BotonAceptarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonAceptarMouseEntered
        PanelBotonAceptar.setBackground(new java.awt.Color(204,86,86));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupErrorD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopupErrorD dialog = new PopupErrorD(new javax.swing.JFrame(), true);
